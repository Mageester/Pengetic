...
const riskClasses: Record<string, string> = {
  ...
  LOW_RISK_ACTIVE: "border-sky-400/20 bg-sky-400/10 text-sky-200",
...
const stateClasses: Record<string, string> = {
  ...
  scope_uploaded: "border-cyan-400/20 bg-cyan-400/10 text-cyan-200",
  scope_validated: "border-cyan-400/20 bg-cyan-400/10 text-cyan-200",
  plan_ready: "border-blue-400/20 bg-blue-400/10 text-blue-200",
  running: "border-indigo-400/20 bg-indigo-400/10 text-indigo-200",
...
const statusClasses: Record<string, string> = {
  ...
  approved: "border-cyan-400/20 bg-cyan-400/10 text-cyan-200",
